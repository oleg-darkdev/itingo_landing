...
<div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4 bg-viol">
 ...
 <div>
    ...
    <ul class="text-gray-300">
      ...
      <li class="mb-4">
        <a href="/volunteer#design" class="hover:underline">Pomóc jako grafica
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#projecting" class="hover:underline">Pomóc z projektowaniem stron
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#security" class="hover:underline">Pomóc z bezpieczeństwom IT
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#seo" class="hover:underline">Pomóc z Seo
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#server" class="hover:underline">Pomóc na serwerze
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#site" class="hover:underline">Pomóc z tworzeniem strony
        </a>
      </li>
      <li class="mb-4">
        <a href="/volunteer#social-media" class="hover:underline">Pomoc w zakresie mediów 
        </a>
      </li>
      <!--<FooterLink>--> 
