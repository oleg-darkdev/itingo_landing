...
<div class="flex w-full justify-center relative ">
  <div style="min-height: 260px; margin-top: -180px;" class="text-center z-2 flex max-w-2xl flex-col bg-viol shadow-md text-gray-500 dark:text-gray-400 rounded-lg  p-4 text-center">
