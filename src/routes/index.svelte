<script>
	...
	import SocialMedia from "../layout/SocialMedia.svelte";
...
<section class="banner items-center  w-full  flex flex-col justify-center">
	<div style="" class="h-auto p-2 bg-viol lg:w-5/12 md:w-6/12  sm:w-10/12  flex flex-col rounded-xl justify-center">
